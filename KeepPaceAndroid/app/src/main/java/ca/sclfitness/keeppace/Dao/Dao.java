...
import ca.sclfitness.keeppace.database.DatabaseHelper;

/**
 * Dao abstract class is a basic data access object
 * which creates basic create, update, and delete operations with SQLite.
 *
